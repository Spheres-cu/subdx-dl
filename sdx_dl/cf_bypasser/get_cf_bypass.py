...
from sdx_dl.cf_bypasser.utils.misc import clean_screen, get_public_ip, md5_hash
...
def get_cache_path(app_name: str = 'subdx-dl', file_name: str | None = 'sdx_cache_connection.json') -> pathlib.Path:
...
def get_cf_bypass(browser: str = '', force: bool = False, proxy: str | None = None, mute: bool = False):
    ...
    hostname = urllib.parse.urlparse(SUBDIVX_PAGE).netloc
